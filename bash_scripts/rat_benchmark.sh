...
python ./stofnet/main.py model=${model} model_file=${model_file} th=1 evaluate=True ch_gap=1 batch_size=1 etol=2 logging=rat_array data_dir=/storage/workspaces/artorg_aimi/ws_00000/chris/Rat18_2D_InVivoBrain/
