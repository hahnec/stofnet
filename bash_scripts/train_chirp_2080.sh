...
python ./stofnet/main.py evaluate=False logging=train data_dir=./datasets/stof_chirp101_dataset th=Null batch_size=64 lr=5e-4 sigma=1 epochs=50 mask_amplitude=1e5 rf_scale_factor=10 hilbert_opt=False
