...
python ./stofnet/main.py model=${model} model_file=${model_file} th=${threshold} evaluate=True batch_size=1 data_dir=./datasets/stof_chirp101_dataset logging=chirp_array rf_scale_factor=10
